        ...
        <table width="150%" border="2" summary="Sarana dan Prasarana" cellpadding="0" cellspacing="0">
          <thead>
			...
			<?php
				...
				$ambil_data = mysql_query("select * from tbl_kurikulum_s2");
				$no = 0;
          ...
          <tbody>
            <tr>
				...
				<td><?php echo $data['pkn2'];?></td>
				<td><?php echo $data['indonesia2'];?></td>
				<td><?php echo $data['penjaskes2'];?></td>
				<td><?php echo $data['inggris2'];?></td>
				<td><?php echo $data['matematika2'];?></td>
				<td><?php echo $data['ipa2'];?></td>
				<td><?php echo $data['kkpi2'];?></td>
				<td><?php echo $data['kwu2'];?></td>
				<td><?php echo $data['fisika2'];?></td>
				<td><?php echo $data['kimia2'];?></td>
				<td><?php echo $data['sunda2'];?></td>
				<td><?php echo $data['plh2'];?></td>
				<td><?php echo $data['produktif12'];?></td>
				<td><?php echo $data['produktif22'];?></td>
				<td><?php echo $data['produktif32'];?></td>
				<td><?php echo $data['produktif42'];?></td>
				<td><?php echo $data['produktif52'];?></td>
                <td><a href="hapus_s2.php?nis=<?php echo $data['nis'];?>">Hapus</a> | <a href="update_s2.php?nis=<?php echo $data['nis'];?>">Edit</a></td>
            </tr>
			<?php } ?>
          </tbody>
        </table>
	<h1>Pemasukan Data Nilai Semester 2</h1>
	<form name="daftar" method="post" action="act_s2.php">
		<table>
			<tr>
				<td>NIS</td>
				<td>:</td>
